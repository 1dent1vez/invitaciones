  ...
  return (
    ...
    >
      <div className="text-center space-y-1">
        ...
        <p className="text-xs text-gray-500">Acompáñanos a celebrar este día tan especial</p>
      </div>
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-3">
            ...
            <div className="space-y-1">
              <label
                htmlFor="rsvp-nombre"
                className="text-2xs font-bold uppercase tracking-wider text-gray-500 block text-left"
              >
                Tu Nombre *
              </label>
              <input
            ...
            <div className="space-y-1">
              <div className="flex justify-between items-center">
                ...
                <span className="text-2xs text-gray-400 font-medium">{mensaje.length}/200</span>
              </div>
              <textarea
                id="rsvp-mensaje"
          ...
          <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.98 }} className="pt-2">
            <a
