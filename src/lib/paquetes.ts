    ...
    esencial: {
      ...
      campos: [
        ...
        },
        {
          ...
          label: 'Dirección',
          required: true,
          placeholder: 'Av. Insurgentes 123, Condesa, CDMX',
        },
        {
          id: 'mapsLink',
          tipo: 'url',
        ...
        },
        {
          ...
          required: true,
          options: ['Adultos', 'Infantil', 'Sorpresa'],
        },
        { id: 'fotoPortada', tipo: 'upload', label: 'Foto del festejado', required: true, max: 1 },
        {
          ...
          required: false,
          placeholder: '¡Vamos a celebrar 30 años de risas!',
        },
        {
          id: 'whatsapp',
          tipo: 'tel',
    ...
    completa: {
      ...
      campos: [
        ...
        },
        {
          ...
          label: 'Música',
          required: true,
          options: ['Fiesta', 'Pop', 'Regional', 'Infantil'],
        },
        {
          id: 'whatsapp',
          tipo: 'tel',
        ...
        },
        {
          ...
          label: 'Dress code',
          required: true,
          options: ['Casual', 'Fiesta', 'Temático', 'Elegante'],
        },
        {
          id: 'dressCodeDesc',
          tipo: 'textarea',
          label: 'Descripción',
          required: false,
          placeholder: 'Vengan cómodos, habrá baile',
        },
        {
          id: 'mensajeFestejo',
          tipo: 'textarea',
          ...
          required: false,
          placeholder: '¡Gracias por ser parte de mi vida!',
        },
        {
          id: 'itinerario',
          tipo: 'textarea',
          label: 'Itinerario',
          required: false,
          placeholder: '19:00 Bienvenida — 20:00 Cena — 21:00 Pastel — 22:00 Baile',
        },
        {
          id: 'datosRegalo',
          tipo: 'textarea',
          label: 'Datos regalos',
          required: false,
          placeholder: 'Si quieres hacerme un regalo...',
        },
        {
          id: 'mesaRegalos',
          tipo: 'boolean',
        ...
        },
        {
          id: 'mesaRegalosDatos',
          tipo: 'text',
          label: 'Datos mesa regalos',
          required: false,
          condicion: 'mesaRegalos',
        },
      ],
    },
    premium: {
      ...
      campos: [
        ...
        },
        {
          id: 'historiaEdad',
          tipo: 'textarea',
          label: '¿Qué significa esta edad?',
          required: true,
          placeholder: 'Los 30 son el inicio...',
        },
        {
          id: 'historiaSeresQueridos',
          tipo: 'textarea',
          label: 'Mensaje a seres queridos',
          required: true,
          placeholder: 'Gracias por siempre estar ahí...',
        },
        {
          id: 'historiaRecuerdo',
          tipo: 'textarea',
          label: 'Un recuerdo favorito',
          required: true,
          placeholder: 'Mi viaje a Europa...',
        },
        ...
        },
        {
          ...
          label: 'Temática',
          required: true,
          options: ['Tropical', 'Vintage', 'Neon', 'Elegante', 'Infantil'],
        },
        { id: 'videoURL', tipo: 'url', label: 'Link video', required: false },
        {
          ...
          required: true,
          options: ['Dorado', 'Plateado', 'Rosa', 'Azul', 'Verde'],
        },
        {
          id: 'fechaLimiteRSVP',
          tipo: 'date',
        ...
        {
          id: 'confettiAnimacion',
          tipo: 'boolean',
          label: 'Activar confetti',
          required: false,
          default: true,
        },
        {
