...
async function main() {
  ...
  const cumpleCompleta = await prisma.pedido.create({
    data: {
      ...
      datosInvitacion: {
        ...
        itinerario:
          '20:00 Bienvenida & Cócteles\n21:30 Cena\n23:00 Brindis & Pastel\n23:30 Abre Pista de Baile',
        datosRegalo:
          'Si deseas hacerme un regalo, puedes realizar una transferencia al banco Santander CLABE: 01234567890 a nombre de Sofía Hernández.',
        mesaRegalos: false,
      },
    },
  });
  ...
  const cumplePremium = await prisma.pedido.create({
    data: {
      ...
      datosInvitacion: {
        ...
        mesaRegalos: false,
        historiaEdad:
          'Llegar a los 30 años representa un nuevo comienzo, una etapa de madurez y de apreciar a quienes realmente importan.',
        historiaSeresQueridos:
          'A mi familia y amigos: gracias por sosterme en cada paso de este viaje. Su amor es mi mejor regalo.',
        historiaRecuerdo:
          'Mi viaje favorito a Japón el año pasado, donde aprendí que la vida se vive paso a paso.',
        fotosExtra: [
  ...
  await prisma.rSVP.createMany({
    data: [
      {
        pedidoId: cumplePremium.id,
        nombre: 'Juan Gómez',
        asiste: true,
        pax: 2,
        telefono: '5511223344',
        mensaje: '¡Felicidades Sofi! Ahí estaremos',
      },
      {
        pedidoId: cumplePremium.id,
        ...
        pax: 1,
        telefono: '5522334455',
        mensaje: '¡Qué gran fiesta se viene!',
      },
      {
        pedidoId: cumplePremium.id,
        ...
        pax: 0,
        telefono: '5533445566',
        mensaje: 'Lo siento, ando fuera de la ciudad',
      },
    ],
  });
