...
test.describe('Completa Package E2E Tests', () => {
      ...
      await prisma.pedido.update({
        ...
        data: {
          ...
          datosInvitacion: {
            ...
            mensaje: '¡Vamos a celebrar!',
            whatsapp: '5512345678',
            fotosGaleria: ['https://images.unsplash.com/photo-1513151233558-d860c5398176'],
            dressCode: 'Casual',
            dressCodeDesc: 'Vente cómodo',
            mensajeFestejo: 'Gracias por venir a mi fiesta',
            itinerario: '20:00 Bienvenida\n22:00 Pastel',
  ...
  test('debería cargar la invitación Completa y mostrar sus secciones principales', async ({
    page,
  }) => {
  ...
  test('debería renderizar la mesa de regalos solo si tieneMesaRegalos / mesaRegalos es true', async ({
    page,
  }) => {
