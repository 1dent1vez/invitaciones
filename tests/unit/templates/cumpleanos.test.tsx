...
describe('Birthday Templates Rendering Tests', () => {
  it('renderiza CumpleEsencial correctamente (No-Regresión)', () => {
    ...
    expect(screen.getByTestId('whatsapp-confirmar')).toHaveAttribute(
      'href',
      'https://wa.me/5512345678'
    );
  });
  ...
  it('mapea los alias de campos correctamente en CumpleCompleta', () => {
    ...
    const aliasImg = imgs.find(
      (img) => img.getAttribute('src') === 'https://example.com/alias-galeria.jpg'
    );
  ...
  it('optimiza la foto de portada si proviene de cloudinary en CumpleEsencial', () => {
    ...
    expect(img).toHaveAttribute(
      'src',
      'https://res.cloudinary.com/demo/image/upload/f_auto,q_auto,w_800/v12345/portada.jpg'
    );
  });
