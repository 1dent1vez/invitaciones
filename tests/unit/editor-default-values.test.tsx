...
describe("EditorClient defaultValues Tests", () => {
  ...
  it("debe restaurar y cargar todos los campos de cumpleaños desde datosInvitacion", () => {
    ...
    const direccionInput = container.querySelector('textarea[name="direccion"]') as HTMLTextAreaElement;
    const fotoPortadaInput = container.querySelector('input[name="fotoPortada"]') as HTMLInputElement;
    const tipoCelebracionInput = container.querySelector('select[name="tipoCelebracion"]') as HTMLSelectElement;
    const mensajeFestejoInput = container.querySelector('textarea[name="mensajeFestejo"]') as HTMLTextAreaElement;
    const itinerarioInput = container.querySelector('textarea[name="itinerario"]') as HTMLTextAreaElement;
    const datosRegaloInput = container.querySelector('textarea[name="datosRegalo"]') as HTMLTextAreaElement;
    const colorPrimarioInput = container.querySelector('input[name="colorPrimario"]') as HTMLInputElement;
    const colorSecundarioInput = container.querySelector('input[name="colorSecundario"]') as HTMLInputElement;
    const historiaEdadInput = container.querySelector('textarea[name="historiaEdad"]') as HTMLTextAreaElement;
    const historiaSeresQueridosInput = container.querySelector('textarea[name="historiaSeresQueridos"]') as HTMLTextAreaElement;
    const historiaRecuerdoInput = container.querySelector('textarea[name="historiaRecuerdo"]') as HTMLTextAreaElement;
    const buzonDeseosInput = container.querySelector('input[name="buzonDeseos"]') as HTMLInputElement;
    ...
    const colorAcentoInput = container.querySelector('select[name="colorAcento"]') as HTMLSelectElement;
